...
class PointTest {
    ...
    void subtract() {
        ...
        assertThrows(
                ...
                () -> p1.subtract(p1),
                "ERROR: subtract() for point from itself does not throw an exception");
    }
    ...
    void distanceSquared() {
        ...
        assertEquals(0, p1.distanceSquared(p1),
                "ERROR: distanceSquared() for point from itself is not zero");
    }
    ...
    void distance() {
        // ============ Equivalence Partitions Tests ==============
        Point p1 = new Point(1, 2, 6);
        Point p2 = new Point(4, 6, 6);
        ...
        assertEquals(
                0,
                p1.distance(p1),
                "ERROR: distance() for point from itself is not zero");
    }
}