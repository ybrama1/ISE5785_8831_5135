...
class VectorTest {
    ...
    void add() {
        ...
        // the result should be an exception to IllegalArgumentException
        assertThrows(
                IllegalArgumentException.class,
                () -> v1.add(v3),
                "ERROR: add() for zero vector does not throw an exception");
    }
    ...
    void subtract() {
        ...
        assertThrows(
                IllegalArgumentException.class,
                () -> v1.subtract(v1),
                "ERROR: subtract() for vector from itself does not throw an exception");
    }
    ...
    void scale() {
        ...
        assertThrows( IllegalArgumentException.class,
                () -> v.scale(0),
                "ERROR: scale() for zero does not throw an exception");
    }
    ...
    void length() {
        ...
        assertEquals(
                5,
                v.length(), "ERROR: length() wrong value");
    }
    ...
    void normalize() {
        ...
        assertThrows(
                ...
                "ERROR: normalize() for zero vector does not throw an exception");
