...
class CameraTest {
   ...
   void testBuilder() {
      ...
      assertEquals(new Ray(Point.ZERO, direction1), camera1.constructRay(2, 2, 0, 0, 0, 0));
      ...
      assertEquals(new Ray(Point.ZERO, direction2), camera2.constructRay(2, 2, 0, 0, 0, 0));
