...
class TriangleTest {
    ...
    void getNormal() {
        ...
        assertTrue(
                t.getNormal(new Point(0.5,0.5,0)).dotProduct(v1) == 0 &&
                        t.getNormal(new Point(0.5,0.5,0)).dotProduct(v2) == 0,
